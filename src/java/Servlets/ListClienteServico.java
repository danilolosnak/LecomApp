 ...
 * @author DaniloPC
 */
@WebServlet(name = "ListClienteServico", urlPatterns = {"/ListClienteServico"})
public class ListClienteServico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher disp = request.getRequestDispatcher("ListClienteServico.jsp");
